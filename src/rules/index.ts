...
import js$builtin$Array$isArray from "./javascript.builtins.Array.isArray.ts";
import js$builtin$Array$join from "./javascript.builtins.Array.join.ts";
import js$builtin$Array$keys from "./javascript.builtins.Array.keys.ts";
...
import js$builtin$Array$sort from "./javascript.builtins.Array.sort.ts";
import js$builtin$Array$sort$stable_sorting from "./javascript.builtins.Array.sort.stable_sorting.ts";
...
const rules = {
	"javascript.builtins.AggregateError.AggregateError":
		js$builtin$AggregateError$AggregateError,
	"javascript.builtins.AggregateError.errors": js$builtin$AggregateError$errors,
	"javascript.builtins.AggregateError.serializable_object":
		js$builtin$AggregateError$serializable_object,
	...
	"javascript.builtins.Array.isArray": js$builtin$Array$isArray,
	"javascript.builtins.Array.join": js$builtin$Array$join,
	"javascript.builtins.Array.keys": js$builtin$Array$keys,
