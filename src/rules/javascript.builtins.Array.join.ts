...
export const seed = createSeed({
  concern: "Array.prototype.join メソッドの使用",
  compatKeys: ["javascript.builtins.Array.join"],
  mdnUrl: "https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/join",
  specUrl: "https://tc39.es/ecma262/multipage/indexed-collections.html#sec-array.prototype.join",  
    ...
    return {
      ...
      CallExpression(node) {
        if (node.callee.type === "MemberExpression") {
          ...
          if (property.type === "Identifier" && property.name === "join") {
