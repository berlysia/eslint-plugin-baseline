...
export const seed = createSeed({
  ...
  mdnUrl: "https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array/flatMap",
  specUrl: "https://tc39.es/ecma262/multipage/indexed-collections.html#sec-array.prototype.flatmap",  
    ...
    return {
      ...
      CallExpression(node) {
        if (node.callee.type === "MemberExpression") {
          ...
          // Check if the method name is "flatMap"
          if (property.type === "Identifier" && property.name === "flatMap") {
