...
export const seed = createSeed({
  concern: "ArrayBuffer.byteLength",
  compatKeys: ["javascript.builtins.ArrayBuffer.byteLength"],
  mdnUrl: "https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer/byteLength",
  specUrl: "https://tc39.es/ecma262/multipage/structured-data.html#sec-get-arraybuffer.prototype.bytelength",
